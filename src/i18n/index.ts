...
const resources = {
  en: {
    translation: {
      ...
      selectListToAdd: 'Select a list or create a new one to add',
      createNewListDescription: 'Create a new list for these ingredients',
      existingLists: 'Existing Lists',
      recipeNotFound: 'Recipe not found',
      authRequired: 'Authentication Required',
      authRequiredToAddToList: 'Sign in to add ingredients to your lists',
      ingredientsAdded: 'Ingredients Added',
      ingredientsAddedToList: 'Added ingredients to the list',
      listCreated: 'List Created',
      listCreatedAndIngredientsAdded: 'Created list and added ingredients',
      goToList: 'Go to List',
      adding: 'Adding...',
      error: 'Error',
      failedToAddIngredients: 'Failed to add ingredients',
      ...
      weeklyList: "Create new list",
      weeklyListDescription: "What do you need today? Build your list without hassle. Everything healthy (and useful) in one place.",
      ...
      // Home greeting translations
      reinventEating: 'Reinvent your way of eating',
      appDescription: 'An app to organize your lists, discover products that are good for you and learn to eat without guilt.',
      cookieTable: {
        name: 'Name',
        domain: 'Domain',
  ...
  es: {
    translation: {
      ...
      weeklyList: "Crear nueva lista",
      weeklyListDescription: "¿Qué necesitas hoy? Arma tu lista sin enredos. Todo lo saludable (y lo útil) en un solo lugar.",
      ...
      // Recipe translations
      servings: 'Porciones',
      cookingMode: 'Modo cocinando',
      addToList: 'Añadir a lista',
      addAllToList: 'Añadir todos a lista',
      addToShoppingList: 'Añadir a Lista de Compras',
      selectListToAdd: 'Selecciona una lista o crea una nueva para añadir',
      createNewListDescription: 'Crear una lista nueva para estos ingredientes',
      existingLists: 'Listas Existentes',
      recipeNotFound: 'Receta no encontrada',
      authRequired: 'Autenticación requerida',
      authRequiredToAddToList: 'Inicia sesión para añadir ingredientes a tus listas',
      ingredientsAdded: 'Ingredientes añadidos',
      ingredientsAddedToList: 'Se añadieron ingredientes a la lista',
      listCreated: 'Lista creada',
      listCreatedAndIngredientsAdded: 'Se creó la lista y se añadieron los ingredientes',
      goToList: 'Ir a la lista',
      adding: 'Añadiendo...',
      error: 'Error',
      failedToAddIngredients: 'No se pudieron añadir los ingredientes',
      ...
      // Home greeting translations
      reinventEating: 'Reinventa tu forma de comer',
      appDescription: 'Una app para organizar tus listas, descubrir productos que te hacen bien y aprender a alimentarte sin culpa.',
      cookieTable: {
        name: 'Nombre',
        domain: 'Dominio',
